...
<div class="container">
	<div class="form-box">
		<h2>비밀번호 찾기</h2>
		<form action="/fruitlight/login/findPassword/submit" method="post">
			<div class="form-group">
				<label for="usr">아이디:</label>
				<input type="text" class="form-control" id="usr" name="shopperId">
			</div>
			<div class="form-group">
			...
			<button type="submit" class="btn findAccountBtn">비밀번호 찾기</button>
		</form>
	</div>
</div>
