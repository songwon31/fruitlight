...
public class MyPageShopperInquiryController {
   ...
   @PostMapping(value="myPageShopperInquiry/deleteInquiry", produces="application/json; charset=UTF-8")
   public void deleteInquiry(@RequestBody ProductInquiry productInquiry) {
	   pageShopperInquiryService.deleteShopperInquiry(productInquiry.getINQUIRY_NO());
   }
